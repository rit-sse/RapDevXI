...
You can download LÖVE for Mac/Windows/Linux and call it on the folder or on the compressed LoveWare2.love file. '.love' files are renamed zip files, so they can be decompressed normally; inside are all the lua scripts (already on the repo).
